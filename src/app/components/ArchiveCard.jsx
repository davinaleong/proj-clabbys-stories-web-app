...
export default function ArchiveCard({
  ...
  return (
    <Link
      href={href}
      className="relative w-full aspect-[4/3] border-4 border-amber-500 bg-amber-500 overflow-hidden"
    >
      {/* Grid of 4 images */}
      <div className="grid grid-cols-2 grid-rows-2 gap-0 w-full h-full">
        {displayImages.map((img, index) => (
          <div
            key={index}
            className="col-span-1 row-span-1 relative border border-amber-500"
          >
            <Image
              src={img}
